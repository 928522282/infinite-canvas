export default {
    ...
    prompts: {
        ...
        targetCanvas: "Prompt input canvas",
        selectCanvas: "Select a canvas for this prompt",
        canvasOption: "Input to: {{title}}",
        noCanvas: "Create a canvas first",
        selectCanvasFirst: "Select a canvas for this prompt first",
        inputToCanvas: "Input to canvas",
        inputToCanvasSuccess: "Added “{{title}}” to the canvas",
        inputWorkflow: "Input workflow",
        workflowInputSuccess: "Created the arranged embedded-Skill workflow and prepared its ordered Codex instruction",
        workflowInputFailed: "Failed to create the short-drama workflow",
        workflowComposer: "Workflow composer",
        workflowComposerDescription: "Arrange Skill cards from left to right. Codex follows this exact order on the canvas.",
        addToWorkflow: "Add to workflow",
        removeFromWorkflow: "Remove from workflow",
        moveEarlier: "Move earlier",
        moveLater: "Move later",
        resetWorkflow: "Reset order",
        workflowEmpty: "Add at least one Skill card first",
        workflowEmptyDescription: "This workflow is empty. Add Skills from the cards below.",
        editTitle: "Edit prompt: {{title}}",
        editSaved: "Prompt saved and all embedded canvas Skills updated",
        editSaveFailed: "Could not save the prompt",
        embeddedSkillNotice: "Saving updates Prompt Center and the embedded Skill snapshot in every canvas. Canvas execution does not depend on local Skill files.",
        localSkillSyncFailed: "The embedded canvas Skill was saved, but the local Agent compatibility copy could not be synchronized",
        skillSyncNotice: "Saving updates the Codex Skill in this canvas workspace. Prompt Center is the only editor for these Skills.",
        skillSyncConnect: "Connect the local Agent before synchronizing and saving this Skill.",
        skillSyncUnsupported: "This prompt card does not map to a synchronized Skill.",
        skillSyncFailed: "Codex Skill synchronization failed; changes were not saved",
        editFields: { title: "Title", description: "Description", tags: "Tags", prompt: "Prompt" },
        resetOriginal: "Restore original",
        resetConfirm: "Discard local changes and restore the bundled prompt?",
        resetSuccess: "Bundled prompt restored",
    },
    assets: {
        title: "My Assets",
    ...
    canvas: {
        ...
        videoWorkflowExport: {
            menu: "Export video workflow", exporting: "Preparing per-VID video workflow…", exported: "Exported {{count}} VID video jobs", failed: "Video workflow export failed", fileSuffix: "video-workflow",
            noVideoPrompts: "No optimized video prompts are available on this canvas", noReadyJobs: "No complete executable VID video jobs are available", missingKeyframes: "{{vid}} is missing key reference images", missingKeyframePrompt: "{{vid}} {{frame}} is missing its key-reference prompt", missingCharacterAssets: "{{vid}} is missing character asset bindings", missingSceneAssets: "{{vid}} is missing scene asset bindings", missingVideoPrompt: "{{vid}} is missing its optimized video prompt", missingNodeFile: "{{vid}} cannot read the node file: {{title}}",
        },
        createMenu: {
    ...
    agent: {
        ...
        connect: { connectorTitle: "Recommended: install the Windows connector", connectorText: "Install it once, then open Infinite Canvas from the Start menu. The connector starts the local Agent in the background, checks Codex, and opens the connected website automatically.", downloadConnector: "Download Windows connector", pluginTitle: "Use the Codex plugin", pluginText: "Install the Infinite Canvas plugin in the Codex app and launch the canvas through it. The plugin starts the local Agent and supplies the connection details automatically.", directTitle: "Developer: run the Agent directly", directText: "Without the connector or Codex plugin, run the command below in a terminal, then return here to connect or enter the Local URL and Connect token manually.", commandCopied: "Command copied", pluginReminder: "Codex plugin note", pluginReminderText: "The tool list enters the Codex context and consumes additional tokens only after installing the Codex plugin or adding MCP manually. Running Canvas Agent alone does not install a global MCP.", removePlugin: "Remove plugin", removeMcp: "Remove manual MCP", copyCommand: "Copy command", title: "Connect local Agent", description: "The Windows connector is recommended; plugin and command-line options remain available for advanced users.", webConnection: "Web connection", autoDiscover: "Opening the website from the connector fills the Local URL and Connect token automatically. A directly opened site can reuse the last saved connection.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Filled by the connector or entered manually" },
