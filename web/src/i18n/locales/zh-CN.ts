export default {
    ...
    prompts: {
        ...
        targetCanvas: "Prompt 输入画布",
        selectCanvas: "选择 Prompt 输入画布",
        canvasOption: "输入到：{{title}}",
        noCanvas: "请先创建画布",
        selectCanvasFirst: "请先选择 Prompt 输入画布",
        inputToCanvas: "输入画布",
        inputToCanvasSuccess: "已将“{{title}}”输入画布",
        inputWorkflow: "输入工作流",
        workflowInputSuccess: "已按当前编排创建内嵌 Skill 工作流，并为 Codex 填好顺序执行指令",
        workflowInputFailed: "创建短剧工作流失败",
        workflowComposer: "工作流编排",
        workflowComposerDescription: "从左到右排列 Skill 卡片；输入画布后 Codex 会严格按此顺序执行。",
        addToWorkflow: "加入流程",
        removeFromWorkflow: "移出流程",
        moveEarlier: "向前移动",
        moveLater: "向后移动",
        resetWorkflow: "恢复默认顺序",
        workflowEmpty: "请先加入至少一张 Skill 卡片",
        workflowEmptyDescription: "当前流程为空，可从下方卡片加入 Skill。",
        editTitle: "编辑提示词：{{title}}",
        editSaved: "提示词已保存，并更新所有画布内嵌 Skill",
        editSaveFailed: "提示词保存失败",
        embeddedSkillNotice: "保存后会更新提示词中心和所有画布中的内嵌 Skill 快照；画布执行不依赖本机 Skill 文件。",
        localSkillSyncFailed: "画布内嵌 Skill 已保存，但本地 Agent 兼容副本同步失败",
        skillSyncNotice: "保存后会同步更新当前画布工作区的 Codex Skill，提示词中心是这些 Skill 的唯一编辑入口。",
        skillSyncConnect: "请先连接本地 Agent，连接成功后才能同步保存 Skill。",
        skillSyncUnsupported: "这张提示词卡片没有对应的可同步 Skill。",
        skillSyncFailed: "同步 Codex Skill 失败，修改未保存",
        editFields: { title: "标题", description: "说明", tags: "标签", prompt: "Prompt 正文" },
        resetOriginal: "恢复原稿",
        resetConfirm: "确定放弃本地修改并恢复内置原稿吗？",
        resetSuccess: "已恢复内置原稿",
    },
    assets: {
        title: "我的资产",
    ...
    canvas: {
        ...
        videoWorkflowExport: {
            menu: "导出视频工作流", exporting: "正在整理逐 VID 视频工作流…", exported: "已导出 {{count}} 个 VID 视频任务", failed: "视频工作流导出失败", fileSuffix: "视频工作流",
            noVideoPrompts: "画布中没有可导出的优化视频提示词", noReadyJobs: "画布中没有完整可执行的 VID 视频任务", missingKeyframes: "{{vid}} 缺少关键参考图", missingKeyframePrompt: "{{vid}} 的 {{frame}} 缺少关键参考图提示词", missingCharacterAssets: "{{vid}} 缺少人物资产绑定", missingSceneAssets: "{{vid}} 缺少场景资产绑定", missingVideoPrompt: "{{vid}} 缺少优化视频提示词", missingNodeFile: "{{vid}} 无法读取节点文件：{{title}}",
        },
        createMenu: {
    ...
    agent: {
        ...
        connect: { connectorTitle: "推荐：安装 Windows 本地连接器", connectorText: "安装一次后，从开始菜单打开 Infinite Canvas。连接器会在后台启动本地 Agent，检查本机 Codex，并自动打开和连接网站。", downloadConnector: "下载 Windows 连接器", pluginTitle: "在 Codex 中使用插件", pluginText: "在 Codex app 安装 Infinite Canvas 插件后，通过插件启动画布，插件会自动启动本地 Agent 并带上连接信息。", directTitle: "开发者：直接运行 Agent", directText: "不安装连接器或 Codex 插件时，在终端运行下面命令，再回到网页里连接或手动填入 Local URL 和 Connect token。", commandCopied: "命令已复制", pluginReminder: "Codex 插件提醒", pluginReminderText: "只有安装 Codex 插件或手动添加 MCP 后，工具列表才会进入 Codex 上下文并增加 token 消耗；仅运行 Canvas Agent 不会安装全局 MCP。", removePlugin: "移除插件", removeMcp: "移除手动 MCP", copyCommand: "复制命令", title: "连接本地 Agent", description: "推荐使用 Windows 本地连接器；插件和命令行保留给高级用户。", webConnection: "网页连接", autoDiscover: "从连接器打开网站会自动填写 Local URL 和 Connect token；手动打开时可使用上次保存的连接信息。", disconnect: "断开", connect: "连接", localAddress: "本地地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "由连接器自动填写，或手动输入 Connect token" },
